...
/*******************************************************************************
 * NRTimer instances are used to time various events and lifecycles in our SDK.
 * When using our API to track your own data:
 * 1) Call createAndStartTimer to retrieve a new, running timer object immediately before
 * beginning whatever work you are tracking.
 * 2) Optionally call [theTimer stopTimer] immediately after the work is complete.
 * 3) Pass your timer object into the NewRelic API when recording your data.
 *
 * Note that all public NewRelic notice... and record... API methods will 
 * stop the timer objects you pass in to them.
 ******************************************************************************/
